...
******************/
    ...
    function getNumViewerGroups() public returns (uint256) {
        return viewerGroups.length;
    }

    function getNumViewers(uint256 group) public returns (uint256) {
        return viewerGroups[group].length;
    }

    function getViewer(uint256 group, uint256 index) public returns (address) {
        return viewerGroups[group][index];
    }

    function getViewerByName(string name) public returns (address) {
        return viewerByName[name];
    }

    function getViewerName(address addr) public returns (string) {
