...
contract AgentRegistry {
    ...
    function AgentRegistry(string name, address contractAddr, string host)
        public
    {
    ...
    function getAgentByName(string name) public returns (address) {
        return agentByName[name];
    }

    function getAgentName(address addr) public returns (string) {
        return agentInfo[addr].name;
    }

    function getAgentContractAddr(address addr) public returns (address) {
        return agentInfo[addr].contractAddr;
    }

    function getAgentHost(address addr) public returns (string) {
        return agentInfo[addr].host;
    }

    function getNumSigners() public returns (uint256) {
        return signers.length;
    }

    function getSigner(uint256 idx) public returns (address) {
        return signers[idx];
    }

    function getNumVoters(address prospective) public returns (uint256) {
    ...
    function getNumYayVotes(address prospective) public returns (uint256) {
        return yayVotes[prospective];
    }

    function getNumProspectives() public returns (uint256) {
        return prospectives.length;
    }

    function getProspective(uint256 idx) public returns (address) {
        return prospectives[idx];
    }

    function getNumKicked() public returns (uint256) {
        return kicked.length;
    }

    function getKicked(uint256 idx) public returns (address) {
        return kicked[idx];
    }

    function getProposer(address prospective) public returns (address) {
